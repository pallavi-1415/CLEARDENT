...
import ManageDoctors from '../../components/dashboard/Admin/ManageDoctors';
import PatientsIndex from '../../components/dashboard/Admin/PatientsIndex';
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex font-sans overflow-x-hidden">
      ...
      <aside className="w-[280px] bg-white border-r border-slate-200 flex flex-col justify-between p-6 shrink-0 shadow-sm">
        <div className="space-y-8">
          ...
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center font-serif font-bold text-slate-900 text-[1rem] tracking-[0.05em] shadow-sm">L</div>
            <div>
              <span className="block font-serif text-[1rem] font-semibold tracking-[0.1em] uppercase text-slate-900 leading-none">Lumina</span>
        ...
        <div className="border-t border-slate-200 pt-6 space-y-4">
          <div className="flex items-center gap-3 px-2">
            ...
            <div>
              ...
              <span className="block text-[0.7rem] text-slate-500 truncate">{currentUser?.email || 'admin@lumina.com'}</span>
            </div>
          </div>
          <button
      ...
      <main className="flex-1 p-10 overflow-y-auto max-h-screen">
        ...
        <header className="flex items-center justify-between mb-10">
          <div>
            <span className="text-[0.72rem] font-bold uppercase tracking-[0.2em] text-blue-700">Lumina Medical Control Center</span>
